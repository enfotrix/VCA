...
public class Adapter_MySquad extends RecyclerView.Adapter<Adapter_MySquad.ViewHolder> {

    Context context;
    ArrayList<Model_MySquad> modelMySquadArrayList;

    public Adapter_MySquad(Context context, ArrayList<Model_MySquad> modelMySquadArrayList) {
        this.context = context;
        this.modelMySquadArrayList = modelMySquadArrayList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final Model_MySquad model_mySquad = modelMySquadArrayList.get(position);
    ...
    public int getItemCount() {
        return modelMySquadArrayList.size();
    }
